...
| Variable              | Description                                        | Default      |
| --------------------- | -------------------------------------------------- | ------------ |
| `PROPLET_TENANT_ID`   | Atom tenant identifier                             | _(required)_ |
| `PROPLET_CHANNEL_ID`  | Atom channel (resource) identifier                 | _(required)_ |
| `PROPLET_ENTITY_ID`   | Atom entity ID for MQTT authentication             | _(required)_ |
| `PROPLET_API_KEY`     | Atom API key for MQTT authentication               | _(required)_ |
